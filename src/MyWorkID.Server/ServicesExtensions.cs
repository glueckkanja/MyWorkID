...
namespace MyWorkID.Server
{
    ...
    public static class ServicesExtensions
    {
        ...
        /// </summary>
        private const string ALLOWED_RANDOM_CHARACTERS =
        ...
        )
        {
            ...
            byte[] signingByte = Encoding.UTF8.GetBytes(
                verifiedIdConfig.JwtSigningKey
                    ?? RandomNumberGenerator.GetString(ALLOWED_RANDOM_CHARACTERS, 30)
            );
            ...
            services
                ...
                .AddJwtBearer(
                    Strings.VERIFIED_ID_CALLBACK_SCHEMA,
                    options =>
                    {
                        options.TokenValidationParameters.ValidateIssuerSigningKey = true;
                        options.TokenValidationParameters.IssuerSigningKey =
                            new SymmetricSecurityKey(signingByte);
            ...
            services
                ...
                .AddPolicy(
                    Strings.VERIFIED_ID_CALLBACK_POLICY,
                    policy =>
                    {
        ...
        public static void ValidateOptionsOnStartup(
            this IServiceCollection services,
            IConfiguration configuration
        )
        {
