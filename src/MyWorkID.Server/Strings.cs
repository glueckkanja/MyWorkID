namespace MyWorkID.Server
{
    ...
    {
        public const string ERROR_INSUFFICIENT_CLAIMS =
            "The presented access tokens had insufficient claims. Please request for claims requested in the WWW-Authentication header and try again.";
        ...
        public const string PASSWORD_VALIDATION_LENGTH_ERROR =
            "Password must be between 8 and 255 characters.";
        public const string PASSWORD_VALIDATION_SYMBOLS_ERROR =
            "Please use characters from at least 3 of these groups: lowercase, uppercase, digits, special symbols.";
        public const string ERROR_INVALID_BODY =
            "Parsed response resulted in error or null object.";
        public const string ERROR_MISSING_OR_INVALID_SETTINGS_GENERATE_TAP =
            "Missing or invalid AppFunctions:GenerateTap auth context setting.";
        public const string ERROR_MISSING_OR_INVALID_SETTINGS_DISMISS_USER_RISK =
            "Missing or invalid AppFunctions:DismissUserRisk auth context setting.";
        public const string ERROR_MISSING_OR_INVALID_SETTINGS_RESET_PASSWORD =
        ...
        public const string ERROR_RESET_PASSWORD_GUEST_USER =
            "Password reset is not supported for guest accounts.";
        public const string ERROR_RESET_PASSWORD_FEDERATED_USER =
            "Password reset is not supported for federated or on-premises synced accounts.";
    }
}
